...
class AdminChangePasswordPage extends StatefulWidget {
  final String email;
  const AdminChangePasswordPage({super.key, required this.email});
...
class _AdminChangePasswordPageState extends State<AdminChangePasswordPage> {
  ...
  Future<void> _changePassword() async {
    ...
    try {
      // Step 1: Find user UID and password in Firestore using email
      ...
      String hashedPassword = userDoc['password']; // Hashed password from Firestore
      ...
      // Step 4: Update password in Firebase Authentication
      ...
      // Step 5: Hash new password and update in Firestore
      ...
      // Step 6: Logout and navigate to login page
      await _auth.signOut();
